...
public class Hoed
{
    public static void Trigger(String Username,String Channel)
    {
        ...
        if(!Now.isAfter(CooldownManager.HOED))
        {
        ...
        else
        {
            ...
            {
                Append = MulticoderTwitchConnection.Config.Hoed[1];
            }
            else{
                Append = MulticoderTwitchConnection.Config.Hoed[0];
            }
            Now = Now.plusSeconds(Append);
            CooldownManager.HOED = Now;
