...
public class Cow
{
    public static void Trigger(String Username,String Channel)
    {
        MulticoderTwitchConnection.SERVER.getPlayerManager().getPlayerList().forEach(player -> {
            ...
            Position.add(2,2,2);
            CowEntity C = new CowEntity(EntityType.COW,player.getServerWorld());
        ...
        MulticoderTwitchConnection.SERVER.getPlayerManager().broadcast(Text.of(Username + " Has ran the command: Cow"),false);
    }
}
