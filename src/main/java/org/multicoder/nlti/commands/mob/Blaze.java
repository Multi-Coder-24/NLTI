...
public class Blaze
{
    public static void Trigger(String Username,String Channel)
    {
        MulticoderTwitchConnection.SERVER.getPlayerManager().getPlayerList().forEach(player -> {
            ...
            Position.add(2,2,2);
            BlazeEntity C = new BlazeEntity(EntityType.BLAZE,player.getServerWorld());
        ...
        MulticoderTwitchConnection.SERVER.getPlayerManager().broadcast(Text.of(Username + " Has ran the command: Blaze"),false);
    }
}
